let scorePlayer = document.getElementById("player");
let scoreAI = document.getElementById("AI");
...
class Ball{
	...
	update() {
		...
		if (this.x < this.r || this.x > width + this.r) {
            if (this.x < this.r) {
                this.scorAI += 1;
                scoreAI.innerHTML = "AI Score: " + this.scorAI;
            }
            else if (this.x > width + this.r) {
                this.scorPlayer += 1;
                scorePlayer.innerHTML = "Player Score: " + this.scorPlayer;
            }
			this.reset();
		}
		this.x += this.xSpeed;
